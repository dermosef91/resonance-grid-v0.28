...
export const BASE_ARTIFACTS: Record<string, UpgradeOption> = {
  ...
  polyrhythm_core: { id: 'polyrhythm_core', name: 'Polyrhythm Core', description: '15% firing frequency on all weapons.', type: 'ARTIFACT', rarity: 'RARE', color: '#ffff00', apply: (p) => { p.artifacts.push('polyrhythm_core'); p.stats.cooldownMult *= 0.85; } },
  ancestral_focus: { 
