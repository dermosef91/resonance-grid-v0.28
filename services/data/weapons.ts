...
export const WEAPON_AUGMENTS: Record<string, [AugmentDef, AugmentDef]> = {
    ...
    void_wake: [
        { id: 'GRAVITATIONAL_WELL', name: 'Gravitational Well', description: 'Trail segments pull nearby enemies towards them.', color: '#FF0055' },
        { id: 'VOID_SIPHON', name: 'Void Siphon', description: 'Enemies standing on the trail take 50% more damage from all sources.', color: '#FFFFFF' }
    ],
    drum_echo: [
